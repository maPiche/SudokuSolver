...
f = open('norvigcounter.txt', 'a')  # fichier log de la performance
f.write("\n \n#Sudoku : " + "Échec/Succès -" + " Nombre d'étapes - \n")
...
#### --- assigner une case est l'exploration d'un état, on incrémente le compteur ---  ######
...
def solve_all(grids, name='', showif=0.0):
    ...
    def time_solve(grid):
        global solutionCounter      #log #sudoku counter
        solutionCounter += 1
        global nbTours              #compteur d'états
        nbTours = 0
        start = time.clock()
        values = solve(grid)
        t = time.clock() - start
